...
exports.getAllUserDetails = async (req,res) =>{
    try {
        ...
        return res.status(500).json({
            success:false,
            message:"unable to get userDetails",
            error:error.message,
        })
    }
}
...
exports.updateDisplayPicture = async (req, res) => {
  ...
  try {
    ...
    const image = await uploaderToCloudinary(
      displayPicture,
      process.env.FOLDER_NAME,
      1000,
      1000
    )
    console.log("update display image: ",image)
...
exports.getEnrolledCourses = async (req, res) => {
  try {
    ...
    console.log("userDetals", userDetails.courses);
